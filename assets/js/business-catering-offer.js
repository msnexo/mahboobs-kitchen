(function () {
  ...
  css.textContent = [
    ...
    "@media(max-width:600px){#cateringEvGrid{grid-template-columns:1fr !important;}.fi-input{padding:15px 0 !important;}#cateringDateCard,#cateringMenuCard,#cateringFormCard{padding:20px 16px !important;}#cateringSubmitBtn{width:100%;}.mki-cat-body{padding:0 8px;}.mki-cat.open .mki-cat-body{padding:0 8px 12px;}.mki-cat-hd{padding:14px 12px;}.mki{padding:11px 12px;}.mkiReco__pill{font-size:0.7rem;padding:4px 8px;}#mkiReco{padding:12px 14px;}}",
    ...
    "@media(max-width:900px){.sticky-cta{display:none!important;}}",
    "@media(max-width:600px){#mkiBuffetStrip img{height:160px !important;}}",
